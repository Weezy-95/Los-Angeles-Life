...
CREATE TABLE `peds` (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `playerpositions` VALUES ('244741995917082624',212.479,-807.811,30.8132,0,0),('398114157276299264',210.462,-794.308,30.9143,-0.494739,0);
...
-- Dump completed on 2023-06-07 19:56:00
